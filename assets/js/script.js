...
function seletionPratos(id) {
  ...
  if (pratoId === "") {
    ...
    if (total.indexOf(document.getElementById(`preço${pratoId.match(/\d+/)[0]}`).innerText) !== -1) {
      total.splice(total.indexOf(document.getElementById(`preço${pratoId.match(/\d+/)[0]}`).innerText),1)
      total.push(preço)
    }
